...
public class PaintTool extends javax.swing.JPanel implements ActionListener {
    ...
    public Image getImageIcon(String path){
        String a = "/Users/thanhhff/Documents/Học tập trên trường/20192/Lý thuyết & Thực hành OOP/De02A_Nhome04-Baocao/data";
        Image image = Toolkit.getDefaultToolkit().getImage(getClass().getResource(a+path));
        return image;
    }
